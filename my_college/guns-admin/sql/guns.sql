...
DROP DATABASE IF EXISTS college_flowable;
CREATE DATABASE IF NOT EXISTS college_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS college;
CREATE DATABASE IF NOT EXISTS college DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `tb_school` (
  ...
  `full_name` varchar(100) DEFAULT NULL COMMENT '学校全称',
  `location` varchar(100) DEFAULT NULL COMMENT '学校位置',
  `phone` varchar(20) DEFAULT NULL COMMENT '学校电话',
  `status` int(11) DEFAULT NULL COMMENT '状态(1：启用  2：冻结  3：删除）',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='学校表';
...
CREATE TABLE `tb_classes` (
  ...
  `num` int(11) DEFAULT NULL COMMENT '排序',
  `simple_name` varchar(50) DEFAULT NULL COMMENT '班级简称',
  `full_name` varchar(100) DEFAULT NULL COMMENT '班级全称',
  `status` int(11) DEFAULT NULL COMMENT '状态(1：启用  2：冻结  3：删除）',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_student` (
  ...
  `gender` int(1) DEFAULT NULL COMMENT '性别（1：男 2：女）',
  `phone` char(11) DEFAULT NULL COMMENT '手机号',
  `role` int(1) DEFAULT NULL COMMENT '角色（1：班干部 2：普通学生）',
  `status` int(11) DEFAULT NULL COMMENT '状态(1：启用  2：冻结  3：删除）',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  `student_num` char(11) DEFAULT NULL COMMENT '学号',
  `password` varchar(32) DEFAULT NULL COMMENT '密码',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_course` (
  ...
  `week_day` int(11) DEFAULT NULL COMMENT '星期1-7',
...
-- ----------------------------
-- Table structure for tb_mini_user
-- ----------------------------
DROP TABLE IF EXISTS `tb_mini_user`;
CREATE TABLE `tb_mini_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `role` TINYINT(1) DEFAULT NULL COMMENT '身份。1：老师，2：班干部，3：普通学生',
  `cids` varchar(50) DEFAULT NULL COMMENT '班级id。老师可能有多个',
  `createtime` datetime NOT NULL COMMENT '创建时间',
  UNIQUE(`phone`),
  UNIQUE(`openId`),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='小程序用户表';