...
public class Android extends BaseEntity {
    ...
    public Android(String positionId, String jobName, String jobSalary, String jobExperience, String jobEducation, String jobAdvantage, String companyShortName, String companyLocation, Date postJobTime, Double companyLatitude, Double companyLongitude) {
